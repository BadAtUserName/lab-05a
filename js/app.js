...
function multiply(a, b) { //eslint-disable-line
  let myProduct = a * b;
  let myProductStr = `The product of ${a} and ${b} is ${myProduct}.`;

  return[myProduct, myProductStr];
...
function multiplyArray(testArray) { //eslint-disable-line
  let productAB = multiply(testArray[0], testArray[1]);
  let valueAB = productAB[0];
  let productThree = multiply(valueAB, testArray[2])[0];
  let productcommaString = testArray.join(',');
  let productArrayStr = `The numbers ${productcommaString} have a product of ${productThree}.`;

  //}
  return [productThree, productArrayStr];
}
